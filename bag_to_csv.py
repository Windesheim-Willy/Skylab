...
HOW TO USE ON WILLY:
- Start Ubuntu ROS + Python required
- Optional: Start terminal and start ROS (Roscore) 
- Create or download BAG files to folder
- Place bag_to_csv.py in same Folder
- Go to created Folder en open a new terminal
